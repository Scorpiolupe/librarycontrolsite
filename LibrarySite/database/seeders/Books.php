...
class Books extends Seeder
{
    public function run(): void
    {
        ...
        $books = [
            ['book_name' => '1984', 'author' => 'George Orwell', 'page_count' => 328, 'category_id' => $categories->random()->id, 'isbn' => '9780451524935', 'publisher' => 'Penguin Books', 'publish_year' => '1949', 'status' => 'mevcut', 'book_cover' => 'https://via.placeholder.com/150'],
            ['book_name' => 'Bülbülü Öldürmek', 'author' => 'Harper Lee', 'page_count' => 281, 'category_id' => $categories->random()->id, 'isbn' => '9780446310789', 'publisher' => 'Grand Central', 'publish_year' => '1960', 'status' => 'mevcut', 'book_cover' => 'https://via.placeholder.com/150'],
            ['book_name' => 'Muhteşem Gatsby', 'author' => 'F. Scott Fitzgerald', 'page_count' => 180, 'category_id' => $categories->random()->id, 'isbn' => '9780743273565', 'publisher' => 'Scribner', 'publish_year' => '1925', 'status' => 'mevcut', 'book_cover' => 'https://via.placeholder.com/150'],
